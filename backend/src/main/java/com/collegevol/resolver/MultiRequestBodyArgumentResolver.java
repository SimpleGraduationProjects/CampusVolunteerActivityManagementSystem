package com.collegevol.resolver;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.collegevol.utils.Constants;
import com.collegevol.utils.JsonMapper;
...
public class MultiRequestBodyArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        ...
        // 非基本类型，允许解析，将外层属性解析
        result = JsonMapper.getInstance().fromJson(jsonObject.toString(), parameterType);
    ...
    private String getRequestBody(NativeWebRequest webRequest) {
        ...
        if (jsonBody == null) {
            try {
                ...
                if (Constants.HTTP_METHOD_POST.equalsIgnoreCase(req.getMethod()) && contentType.indexOf("json") != -1) {
                    ...
                    for (Iterator iter = paramMap.keySet().iterator(); iter.hasNext(); ) {
                        ...
                        reqMap.put(name, URLDecoder.decode(valueStr));
                    }
                    jsonBody = JsonMapper.getInstance().toJson(reqMap);
                }
